  ...
  $.mbMiniPlayer={
    ...
    buildPlayer:function(options){
      ...
      if (navigator && navigator.platform && navigator.platform.match(/^(iPad|iPod|iPhone)$/)) {
        $.mbMiniPlayer.icon.play="<img src='/assets/img/play.png'/>";
        $.mbMiniPlayer.icon.pause="<img src='/assets/img/pause.png'/>";
        $.mbMiniPlayer.icon.stop="<img src='/assets/img/stop.png'/>";
        $.mbMiniPlayer.icon.rewind="<img src='/assets/img/rewind.png'/>";
        $.mbMiniPlayer.icon.volume="<img src='/assets/img/volume.png'/>";
        $.mbMiniPlayer.icon.volumeMute="<img src='/assets/img/volume.png'/>";
