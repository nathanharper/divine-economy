...
require_once APPPATH.'vendor'.DS.'Smarty'.DS.'libs'.DS.'Smarty.class.php';
...
class View_Smarty extends \View {
	...
	public static function parser() // I made this static because it was getting an error otherwise. seems okay... -Nathan
	{
